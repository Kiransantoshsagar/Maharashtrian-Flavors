...
// Create a log table and trigger automatically
try {
    ...
    // Create trigger (ignore error if already exists)
    $triggerSQL = "
    DELIMITER $$
    CREATE TRIGGER after_registration_insert
    AFTER INSERT ON registration1
    FOR EACH ROW
    BEGIN
...
if (isset($_POST['add'])) {
    ...
    $insert = "INSERT INTO `registration1`(`name`, `email`, `password`, `gender`, `age`, `city`) VALUES ('$name','$email','$pass','$gender','$age','$city')";
        ...
        <div class="container text-center">
            <div class="row gx-5">
                ...
                <div class="login-container p-xxl-3">
                    <h2 class="display-3 mb-4 pt-2 text-font-2 text-light">REGISTER TO ORDER</h2>
